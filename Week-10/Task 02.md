## To create an Event Hub that captures the real-time stream, you need to create an Event Hub namespace and an event hub in the namespace. You can do this using the Azure portal or Azure CLI.
